...
class Admin::UsersController < AdminController
    ...
    def index
      ...
      # Filter options
      @users = @users.where(is_admin: true) if params[:filter] == 'admins'
      @users = @users.where(is_admin: false) if params[:filter] == 'customers'
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :phone, :is_admin)
    end
  end